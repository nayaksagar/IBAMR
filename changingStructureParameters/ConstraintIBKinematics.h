...
public:
    ...
    public:
        ...
        inline void resetStructureIsSelfTranslating()
        {
     ...
     */
    inline StructureParameters& getStructureParameters()
    {
     ...
     */
    virtual std::vector<std::vector<double> >& getKinematicsVelocity(const int level) = 0;
